    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div class="bg-blue-50 border border-blue-200 rounded-xl p-6">
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="font-bold text-blue-900 mb-2">Como Ganhar Pontos</h3>
                    <ul class="text-blue-800 space-y-1 text-sm">
                        <li>• Reset mensal: +30 pontos no início de cada mês</li>
                        <li>• Cancelar com antecedência: recupera 3 pontos</li>
                        <li>• Usar menos do que alocado: bónus no fim do mês</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="bg-red-50 border border-red-200 rounded-xl p-6">
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="font-bold text-red-900 mb-2">Como Perder Pontos</h3>
                    <ul class="text-red-800 space-y-1 text-sm">
                        <li>• Fazer reserva: -5 pontos por dia</li>
                        <li>• Não comparecer: -10 pontos adicionais</li>
                        <li>• Cancelar em cima da hora: -2 pontos</li>
                    </ul>
                </div>
            </div>
        </div>
